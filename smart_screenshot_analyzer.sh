...
# 🔐 API-ключ Mistral
MISTRAL_API_KEY="..." # Замените на ваш реальный ключ
...
CONTEXT="Ты - эксперт по анализу текста. Отвечай ТОЛЬКО номером правильного ответа (1, 2, 3 и т.д.) без каких-либо пояснений, рассуждений или дополнительного текста. Если вопрос не содержит вариантов ответа, верни '0'."
