...
CONTEXT="Ты - эксперт по анализу текста. Отвечай ТОЛЬКО текстом правильного ответа, без каких-либо пояснений, рассуждений или дополнительного текста. Если вопрос не содержит вариантов ответа, верни '0'."
...
if ! echo "$RESPONSE" | jq empty 2>/dev/null; then
    echo "❌ Ошибка: Невалидный или пустой JSON-ответ от AI"
    exit 1
fi
